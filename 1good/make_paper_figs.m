% This script illustrates the effects of endogenous risk
...
for i = 2:size(gridso,1)
    ...
    figure(fn + 6);
    set(gca, 'ColorOrderIndex', i); hold on
    plot(grids{i}.eta, grids{i}.xi .* sqrt(grids{i}.sig_xiA.^2 + grids{i}.sig_xiB.^2), line_types{i}); hold on

    figure(fn + 7);
    set(gca, 'ColorOrderIndex', i); hold on
    plot(gridso{i}.eta, gridso{i}.xi .* sqrt(gridso{i}.sig_xiA.^2 + gridso{i}.sig_xiB.^2), line_types{i}); hold on
end
figure(fn + 5);
xlabel('\eta');
...
for i = 1:size(gridso,1)
    figure(fn + 8);
    set(gca, 'ColorOrderIndex', i); hold on
    plot(gridso{i}.eta, gridso{i}.q .* sqrt(gridso{i}.sig_qA.^2 + gridso{i}.sig_qB.^2), line_types{i}); hold on
end
...
savefig = figure(23);
saveas(savefig, 'figures/volq_LAno_1_p5_p1_LBno', 'epsc');
savefig = figure(20006);
saveas(savefig, 'figures/volxi_LA1_p5_p1_LBno', 'epsc');
savefig = figure(20007);
saveas(savefig, '../figures/volxi_LA1_p5_p1_LBno', 'epsc');
savefig = figure(20008);
saveas(savefig, '../figures/volq_LAno_1_p5_p1_LBno', 'epsc');
